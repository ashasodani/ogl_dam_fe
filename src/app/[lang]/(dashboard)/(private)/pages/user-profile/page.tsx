...
// Component Imports
import UserProfile from '@shared/pages/user-profile'

// Data Imports
import { getProfileData } from '@/app/server/actions'

const ProfileTab = dynamic(() => import('@shared/pages/user-profile/profile'))
const TeamsTab = dynamic(() => import('@shared/pages/user-profile/teams'))
const ProjectsTab = dynamic(() => import('@shared/pages/user-profile/projects'))
const ConnectionsTab = dynamic(() => import('@shared/pages/user-profile/connections'))
